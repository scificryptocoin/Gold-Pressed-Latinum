...
After completing windows setup then run windows command line (cmd)
  cd daemon
  goldpressedlatinumd
You would need to create a configuration file goldpressedlatinum.conf in the default
wallet directory. Grant access to goldpressedlatinumd.exe in anti-virus and firewall
...
goldpressedlatinumd backupwallet <destination_backup_file>
Then shutdown ppcoind by
goldpressedlatinumd stop
Start up the new goldpressedlatinumd (0.3.0).

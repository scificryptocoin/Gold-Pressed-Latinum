...
static const int64 MIN_TX_FEE = 0.02 * CENT;
static const int64 MIN_RELAY_TX_FEE = 0.02 * CENT;
...
static const uint256 hashGenesisBlockOfficial("0x00000164dc3880ea186076b3f54652254df73f30aa94cab098dd50b1831766ef");
...
// goldpressedlatinum: calculate Nfactor using timestamp
...
public:
    ...
    {
        // Protocol switch to support p2pool at goldpressedlatinum block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before goldpressedlatinum block #9689 - old protocol
